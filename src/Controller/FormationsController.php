...
/**
 * Controleur des formations - gestion des routes de la page des formations
 *
 * @author emds
 */
class FormationsController extends AbstractController {
     ...
     * Et sur le $champ et l'ordre, si une autre $table
     ...
     * Et selon le $champ et la $valeur, si une autre $table
